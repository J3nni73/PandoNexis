...
using Litium.Accelerator.Mvc.Controllers._Addons.PNBlockInfoTile;

namespace Litium.Accelerator.Mvc.Definitions.Addons
{
    [ServiceDecorator(typeof(FieldTemplateSetup))]
    public class InfoTileBlockFieldTemplateSetupDecorator : FieldTemplateSetup
    {
        ...
        public InfoTileBlockFieldTemplateSetupDecorator(FieldTemplateSetup parent)
        {
            _parent = parent;
        }
