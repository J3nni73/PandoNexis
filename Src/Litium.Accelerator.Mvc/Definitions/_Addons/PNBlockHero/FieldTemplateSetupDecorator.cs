...
using Litium.Accelerator.Mvc.Controllers._Addons.PNBlockHero;
...
namespace Litium.Accelerator.Mvc.Definitions.Addons
{
    ...
    public class HeroBlockFieldTemplateSetupDecorator : FieldTemplateSetup
    {
        ...
        public HeroBlockFieldTemplateSetupDecorator(FieldTemplateSetup parent)
        {
            _parent = parent;
        }
