...
using Litium.Accelerator.Mvc.Controllers._Addons.PNBlockUsp;

namespace Litium.Accelerator.Mvc.Definitions.Addons
{
    [ServiceDecorator(typeof(FieldTemplateSetup))]
    public class UspBlockFieldTemplateSetupDecorator : FieldTemplateSetup
    {
        ...
        public UspBlockFieldTemplateSetupDecorator(FieldTemplateSetup parent)
        {
            _parent = parent;
        }
