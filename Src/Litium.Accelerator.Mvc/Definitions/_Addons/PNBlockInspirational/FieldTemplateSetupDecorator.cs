...
using Litium.Accelerator.Mvc.Controllers._Addons.PNBlockInspirational;

namespace Litium.Accelerator.Mvc.Definitions.Addons
{
    [ServiceDecorator(typeof(FieldTemplateSetup))]
    public class InspirationalBlockFieldTemplateSetupDecorator : FieldTemplateSetup
    {
        ...
        public InspirationalBlockFieldTemplateSetupDecorator(FieldTemplateSetup parent)
        {
            _parent = parent;
        }
