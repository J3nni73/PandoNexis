...
import { getGenericGridViewForExport } from '../../Actions/GenericGridView.action';
...
const ExportButton = () => {
  ...
  function exportData(event) {
    ...
    dispatch(getGenericGridViewForExport());
  }

  return (
    <Fragment>
      <button className="generic-grid-view__button-export secondary" onClick={(event) => exportData(event)} >
...
//       <Fragment>
//         <button
//           className="generic-grid-view__button-export secondary"
