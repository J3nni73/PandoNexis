    ...
    return (
      <div className="columns">
        ...
        <div className="card">
          {cardIngressField && (
            <div {...register(cardIngressField.fieldId)}>
              <GenericDataViewField
                isEditable={
                  cardIngressField.settings &&
                  cardIngressField.settings.editable
                }
                type={cardIngressField.fieldType}
                suffix={cardIngressField.fieldSuffix}
                defaultValue={
                  cleanData(
                    cardIngressField.fieldValue,
                    cardIngressField.fieldType
                  ) || ''
                }
                ...
                onBlur={
                  cardIngressField.fieldType !== 'autocomplete' &&
                  cardIngressField.fieldType !== 'dropdown' &&
                  cardIngressField.fieldType !== 'productimageupload' &&
                  cardIngressField.fieldType !== 'dropdown'
                    ? handleSubmit(onBlur)
                    : null
                }
          ...
          <div
            className={`row small-up-${columnsInsideContainerSmall} medium-up-${columnsInsideContainerMedium} large-up-${columnsInsideContainerLarge}`}
          >
            {cardFields.map(
              (
                {
                ...
                >
                  {settings.fieldMessage && (
                    <span
                      ...
                      dangerouslySetInnerHTML={{
                        __html: settings.fieldMessage,
                      }}
                    ></span>
                  )}
                  {showTitles &&
                    fieldType !== 'button' &&
                    settings.genericButtons?.length < 1 && <b>{fieldName}</b>}
                  ...
                  <GenericDataViewField
                    ...
                    entitySystemId={entitySystemId}
                    nextEntitySystemId={
                      fieldIndex !== cardFields.length - 1
