...
const PNGenericDataViewContainer = ({
    pageSystemId,
    ...props }) => {
                    ...
                    <div className="generic-data-view__modal-wrapper">
                        ...
                        <div className={`generic-data-view__modal`}>
                            <GenericDataView
                                ...
                                isInModal={true}
                                {...props}
                                {...{ pageSystemId, dataContainers: genericDataView.modalDataContainers, settings: genericDataView.modalSettings }}
                            />
                        </div>
                    </div>
                }
