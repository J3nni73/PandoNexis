...
namespace PandoNexis.AddOns.Extensions.PNInfiniteScroll.Definitions.WebsiteTexts
{
    public class TextSource : IWebsiteTextSource
    {
        ...
        public List<WebsiteTextDefinition> GetTexts()
        {
            ...
            return new List<WebsiteTextDefinition>
            {
                ...
                // Infinite scroll
                "infinitescroll.buttontext".AsWebsiteTextDefinition("Load more", "Visa mer", clientAvailable: true, serverAvailable: false),
                "infinitescroll.showingtext".AsWebsiteTextDefinition("Showing [currentTotal] of [totalCount]", "Visar [currentTotal] av [totalCount]", clientAvailable: true, serverAvailable: false),
