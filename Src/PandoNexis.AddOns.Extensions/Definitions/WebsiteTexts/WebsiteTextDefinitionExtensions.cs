...
namespace PandoNexis.AddOns.Extensions.Definitions.WebsiteTexts
{
    ...
    {
        public static WebsiteTextDefinition AsWebsiteTextDefinition(this string id, string english, string swedish, IEnumerable<Guid> websiteIds = null, bool clientAvailable = false, bool serverAvailable = true, bool overrideText = false)
        {
