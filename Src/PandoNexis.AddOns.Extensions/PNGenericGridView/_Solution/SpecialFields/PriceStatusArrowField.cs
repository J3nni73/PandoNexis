...
{
    [Plugin("PriceStatusArrow")]
    public class PriceStatusArrowField : GridSpecialFieldDataBase
    {

        private readonly RequestModelAccessor _requestModelAccessor;

        public PriceStatusArrowField(RequestModelAccessor requestModelAccessor)
        {
