...
namespace PandoNexis.AddOns.Extensions.PNGenericGridView._Solution.Processors
{
    ...
    public class QuickBuyProcessor : GridViewDataProcessorBase
    {
        ...
        public QuickBuyProcessor(GenericGridViewService genericGridViewService, CartContextAccessor cartContextAccessor, CartViewModelBuilder cartViewModelBuilder)
        {
