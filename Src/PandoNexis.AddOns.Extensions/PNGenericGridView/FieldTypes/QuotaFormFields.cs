...
{
    [Plugin("QuotaFormField")]
    public class QuotaFormField : GridSpecialFieldDataBase
    {
        ...
        public QuotaFormField(CartContextAccessor cartContextAccessor,
