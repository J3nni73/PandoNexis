...
namespace PandoNexis.AddOns.Extensions.Block.HeroBlock
{
    public class HeroBlockViewModel : IViewModel, IAutoMapperConfiguration
    {
        ...
        public ImageModel BlockMobileImage { get; set; } = new ImageModel();
        ...
        void IAutoMapperConfiguration.Configure(IMapperConfigurationExpression cfg)
        {
            cfg.CreateMap<BlockModel, HeroBlockViewModel>()
               ...
               .ForMember(x => x.BlockMobileImage, m => m.MapFrom(c => c.Fields.GetValue<Guid>(BlockFieldNameConstants.BlockMobileImage).MapTo<ImageModel>()))
