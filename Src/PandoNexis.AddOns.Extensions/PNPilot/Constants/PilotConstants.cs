...
namespace PandoNexis.AddOns.PNPilot.Constants
{
    public static class PilotConstants
    {
        ...
        public const string AssignedPersonSystemId = "AssignedPersonSystemId";
        public const string Assigned = "Assigned";
        public const string ReportedByPersonSystemId = "ReportedByPersonSystemId";
        public const string ReportedBy = "ReportedBy";
        public const string Estimate = "Estimate";
        public const string EstimatedComment = "EstimatedComment";

        public const string SumTimeSpent = "SumTimeSpent";
        public const string AddTimeSpent = "AddTimeSpent";
        public const string AddTimeSpentFrom = "AddTimeSpentFrom";
        public const string AddTimeSpentTo = "AddTimeSpentTo";
        public const string AddTimeSpentComment = "AddTimeSpentComment";
        ...
        public const string ItemTypeSystemId = "ItemTypeSystemId";
        public const string ItemStatusSystemId = "ItemStatusSystemId";
        ...
        public const string PersonSystemId = "PersonSystemId";
    ...
    public static class PilotFieldNameConstants
    {
        ...
        public const string PilotAdminGroup = "PilotAdminGroup";
    ...
    public static class ProjectTypeConstants
    {
        ...
        public const string NextFramework = "NextFramework";
