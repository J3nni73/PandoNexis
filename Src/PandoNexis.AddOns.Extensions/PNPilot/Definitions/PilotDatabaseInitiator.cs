    ...
    public class PilotDatabaseInitiator : DatabaseInitiator
    {
        ...
        public List<DatabaseColumns> GetItemColumns()
        {
            var result = new List<DatabaseColumns>
            {
                ...
                GetColumn(PilotConstants.AssignedPersonSystemId, DatabaseTypeConstants.UniqueIdentifier, DatabaseTypeConstants.Null),
                GetColumn(PilotConstants.ReportedByPersonSystemId, DatabaseTypeConstants.UniqueIdentifier, DatabaseTypeConstants.Null)
            };
        ...
        public List<DatabaseColumns> GetTimeColumns()
        {
            var result = new List<DatabaseColumns>
            {
                ...
                GetColumn(PilotConstants.PersonSystemId, DatabaseTypeConstants.UniqueIdentifier, DatabaseTypeConstants.Null)
            };
            result.AddRange(GetEditedColumns());
            return result;
        }
